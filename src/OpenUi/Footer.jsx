...
const Footer = () => {
  ...
  return (
    <div className="w-full">
      {/* Top Section */}
      <div className="w-full bg-blue-100 flex flex-col md:flex-row justify-around items-center text-center font-serif py-6 gap-6">
        <div>
      ...
      <div className="w-full bg-blue-300">
        <div className="flex flex-col md:flex-row justify-around p-6 md:p-10 gap-8 md:gap-0 text-center md:text-left">
          ...
          <ul className="font-serif space-y-2">
            <li className="font-semibold">Dummy name</li>
            <li>Head Office</li>
            <li>MC Road Kottayam, 686633</li>
            <li>Kalikavu</li>
            <li className={stylesh}>Call us : 1300 228 252</li>
          ...
          {/* Column 2 */}
          <ul className="font-serif space-y-2">
            <li className="font-semibold">Shop by</li>
